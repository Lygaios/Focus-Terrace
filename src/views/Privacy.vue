    ...
    <div class="content-container">
      ...
      <div class="policy-content">
        <section class="section">
          ...
          <p><strong>Effective: August 1, 2025</strong></p>
        </section>
        ...
        <section class="section">
          ...
          <div class="legal-details">
            ...
            <div class="retention-info">
              <p><strong>Retention and Deletion of Data:</strong> The following general deadlines apply to retention and archiving under German law:</p>
              <ul>
                <li><strong>10 years</strong> – for books and records, annual financial statements, inventories, management reports, opening balances, and documentation necessary for understanding these (§ 147 para. 1 no. 1 in conjunction with para. 3 AO, § 14b para. 1 UStG, § 257 para. 1 no. 1 in conjunction with para. 4 HGB).</li>
                <li><strong>8 years</strong> – booking receipts such as invoices and cost receipts (§ 147 para. 1 nos. 4 and 4a in conjunction with para. 3 sentence 1 AO, and § 257 para. 1 no. 4 in conjunction with para. 4 HGB).</li>
                <li><strong>6 years</strong> – other business documents: received business letters, copies of sent business letters, other documents relevant to taxation such as time sheets, cost sheets, calculation documents, price tags, and payroll documents not already considered booking receipts (§ 147 para. 1 nos. 2, 3, 5 in conjunction with para. 3 AO, § 257 para. 1 nos. 2 and 3 in conjunction with para. 4 HGB).</li>
                <li><strong>3 years</strong> – data necessary for considering potential warranty and damage claims or similar contractual rights and processing related inquiries, stored for the duration of the standard statutory limitation period of three years (§§ 195, 199 BGB).</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <div class="attribution">
          <a href="https://datenschutz-generator.de/" target="_blank" rel="noopener noreferrer nofollow" class="external-link">
